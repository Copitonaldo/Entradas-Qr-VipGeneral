...
Ref: ${outReferencia.textContent}`;
            ...
            if (outTipoEntradaContenedor && outTipoEntradaContenedor.style.display !== 'none' && outTipoEntrada.textContent) { // Asumiendo que añades un contenedor para tipo entrada
                datosQRClone += `
